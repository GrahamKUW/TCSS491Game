...
class PlayerInputSystem {
    update(deltaTime, game) {
        ...
        if (game.inputBlockDuration > 0) {
            game.inputBlockDuration -= deltaTime;
            //console.log("Player input blocked by level load! Remaining duration: " + game.inputBlockDuration.toFixed(3) + "Seconds");
        } else {
