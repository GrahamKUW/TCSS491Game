...
class PhysicsSystem {
  ...
  static updateVelocity(physicsComponent, deltaTime) {
    ...
    finalVel.x = physicsComponent.velocity.x + physicsComponent.acceleration.x * deltaTime;
    finalVel.y = physicsComponent.velocity.y + physicsComponent.acceleration.y * deltaTime;
  ...
  static updatePosition(transformComponent) {
    ...
    transformComponent.position.x = physicsComponent.velocity.x * deltaTime + 1/2 * physicsComponent.acceleration.x;
    transformComponent.position.y = physicsComponent.velocity.y * deltaTime + 1/2 * physicsComponent.acceleration.y;
  }
}